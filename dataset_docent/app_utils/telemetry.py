...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=dataset-docent,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning("No Google default credentials found. OpenTelemetry exporters not configured.")
